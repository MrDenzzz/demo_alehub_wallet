                        ...
                        <div class="col-12">
                            <div class="login-form">
                                ...
                                <div class="control" @click="focusInput('fullname')">
                                    ...
                                    <input type="text" @keyup.enter="register" v-model="fullName"
                                           placeholder="full name" id="fullname">
                                </div>

                                <div class="control" @click="focusInput('email')">
                                    <label for="email">e-mail</label>
                                    <input v-validate="'email'" @keyup.enter="register" v-model="email" type="text"
                                           placeholder="e-mail" id="email">
                                </div>

                                <div class="control" @click="focusInput('phone')">
                                    <label for="phone">phone number</label>
                                    <input type="text" @keyup.enter="register" v-model="phoneNumber"
                                           placeholder="phone number" id="phone">
                                </div>

                                <div class="control" @click="focusInput('password')">
                                    <label for="password">password</label>
                                    <input type="password" @keyup.enter="register" v-model="password"
                                           placeholder="password" id="password">
                                </div>

                                <div class="control" @click="focusInput('repeatpass')">
                                    <label for="repeatpass">Repeat Password</label>
                                    <input type="password" @keyup.enter="register" v-model="passwordConfirm"
                                           placeholder="password" id="repeatpass">
                                </div>
